  ...
  return (
    <footer className="relative border-t border-white/5 mt-20">
      ...
      <div className="container relative py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/products?cat=floormat" className="text-white/50 hover:text-white">汽车脚垫</Link></li>
              <li><Link href="/products?cat=wheelcover" className="text-white/50 hover:text-white">手缝方向盘套</Link></li>
              <li><Link href="/cases" className="text-white/50 hover:text-white">案例展示</Link></li>
              <li><Link href="/craft" className="text-white/50 hover:text-white">工艺优势</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/30">
          <p>
