...
export function ProductLineCard({ slug, name, subtitle, coverUrl, count }: Props) {
  ...
  return (
    <Link
      ...
      className="group relative aspect-[4/3] rounded-3xl overflow-hidden bg-ink-800 block"
    >
      {coverUrl ? (
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-brand-700/30 to-ink-900 flex items-center justify-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
        ...
        {subtitle && <p className="text-white/60 mb-4 max-w-md">{subtitle}</p>}
