          ...
          <div className="container">
            <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
              <div>
                ...
                <p className="text-white/50">真实客户实拍，所见即所得</p>
              </div>
              <Link href="/cases" className="text-brand-400 hover:text-brand-300 text-sm">
                查看全部案例 →
              </Link>
            </div>
      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50">从原料到成品，每个环节都严格把控</p>
          </div>
          ...
          <div className="container">
            <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
              <div>
                ...
                <p className="text-white/50">查看我们最近上架的新品</p>
              </div>
              <Link href="/products" className="text-brand-400 hover:text-brand-300 text-sm">
                查看全部产品 →
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {latestProducts.map((p) => {
                ...
                return (
                  ...
                  >
                    <div className="aspect-square rounded-lg bg-white/5 overflow-hidden mb-3">
                      {p.coverImage ? (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img
                          src={p.coverImage}
                    ...
                    {features[0] && <div className="text-xs text-white/40 line-clamp-1">{features[0]}</div>}
                  </Link>
                )
              })}
            </div>
