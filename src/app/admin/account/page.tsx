  ...
  return (
    <div className="max-w-md">
      ...
      <form onSubmit={submit} className="card space-y-4">
        ...
        {msg && (
          <div className={`rounded-lg px-4 py-2 text-sm ${msg.type === 'ok' ? 'bg-green-500/10 border border-green-500/30 text-green-300' : 'bg-red-500/10 border border-red-500/30 text-red-300'}`}>
            {msg.text}
          </div>
        )}
